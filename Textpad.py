...
#------------------Main Menu --------------------
#_________________End Main Menu ________________________
main_menu = tk.Menu()
#file Icons
...
file= tk.Menu(main_menu,tearoff=False) # // tearoff mean at the top of the icons line will not show
...
main_menu.add_cascade(label="color_theme", menu=color_theme,compound=tk.LEFT)
...
#_________________End Toolbar________________________________________
...
#_________________End Text Editor________________________
...
for i in color_dict:
    ...
    count += 1 
#_________________End Main Menu Functionality________________________


#------------------Main Menu --------------------
#_________________End main________________________
